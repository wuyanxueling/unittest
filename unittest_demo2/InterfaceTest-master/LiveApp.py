...
# 接口测试
def interfaceTest(
        num, api_purpose, api_host, request_url, request_data, check_point, request_method, request_data_type, session):
    headers = {'Content-Type': 'application/x-www-form-urlencoded',
               'Accept-Encoding': 'gzip',
               'Connection': 'Keep-Alive',
               'Referer': 'http://' + api_host,
               'User-Agent': 'bixin_android/2020042601 (Channel/bixin; com.bixin.bixin_android; UUID/9b0ebb1f-c7bd-44c1-8faf-b2dd1d071411; Version/3.8.6; DeviceModel/vivo_V1916A; SystemVersion/10)'}
